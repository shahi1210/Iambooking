  ...
  return (
    <div className="fp">
      ...
      <div className="fpItem">
        ...
        <span className="fpPrice">Starting from ₹1999</span>
        <div className="fpRating">
          <button>9.3</button>
      ...
      <div className="fpItem">
        <img
          src="https://images.pexels.com/photos/161758/governor-s-mansion-montgomery-alabama-grand-staircase-161758.jpeg?auto=compress&cs=tinysrgb&w=1600"
          alt=""
          className="fpImg"
        />
